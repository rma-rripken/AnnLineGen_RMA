...
FUNCTION AnnLineGen(Qsac_prv,Qexp_prv,Qsjr_prv,DXC_prv,DICU_prv,Qsac_oth_prv,Qexp_oth_prv,VernEC_prv,mon,&
  ...
  INTEGER,INTENT(IN) :: location,variable,ave_type,currMonth,currYear,ForceOption !Shengjun 2/15/2005
  INTEGER            :: i,tim0,tim1,tim2,tim3,tim4,tim5,tryNo,mon0,mon1,mon2,mon3,mon4
  INTEGER           ::  SFtideStartIndex,SFtideEndIndex
  
  REAL    :: Qsac_prv0,Qsac_prv1,Qsac_prv2,Qsac_prv3,Qexp_prv0,Qexp_prv1,Qexp_prv2,Qexp_prv3,&
...
!!endchange
  ...
  Qsac_prv0 = Qsac_prv(1)
  Qsac_prv1 = Qsac_prv(2)
  Qsac_prv2 = Qsac_prv(3)
  Qsac_prv3 = Qsac_prv(4)
  Qexp_prv0 = Qexp_prv(1)
  Qexp_prv1 = Qexp_prv(2)
  Qexp_prv2 = Qexp_prv(3)
  Qexp_prv3 = Qexp_prv(4)
  Qsjr_prv0 = Qsjr_prv(1)
  Qsjr_prv1 = Qsjr_prv(2)
  Qsjr_prv2 = Qsjr_prv(3)
  Qsjr_prv3 = Qsjr_prv(4)
  Qsjr_fut = Qsjr_prv(5)
  DXC_prv0 = DXC_prv(1)
  DXC_prv1 = DXC_prv(2)
  DXC_prv2 = DXC_prv(3)
  DXC_prv3 = DXC_prv(4)
  DXC_fut = DXC_prv(5)
  DICU_prv0 = DICU_prv(1)
  DICU_prv1 = DICU_prv(2)
  DICU_prv2 = DICU_prv(3)
  DICU_prv3 = DICU_prv(4)
  DICU_fut = DICU_prv(5)
  Qsac_oth_prv0 = Qsac_oth_prv(1)
  Qsac_oth_prv1 = Qsac_oth_prv(2)
  Qsac_oth_prv2 = Qsac_oth_prv(3)
  Qsac_oth_prv3 = Qsac_oth_prv(4)
  Qsac_oth_fut = Qsac_oth_prv(5)
  Qexp_oth_prv0 = Qexp_oth_prv(1)
  Qexp_oth_prv1 = Qexp_oth_prv(2)
  Qexp_oth_prv2 = Qexp_oth_prv(3)
  Qexp_oth_prv3 = Qexp_oth_prv(4)
  Qexp_oth_fut = Qexp_oth_prv(5)
  VernEC_prv0 = VernEC_prv(1)
  VernEC_prv1 = VernEC_prv(2)
  VernEC_prv2 = VernEC_prv(3)
  VernEC_prv3 = VernEC_prv(4)
  VernEC_fut = VernEC_prv(5)
  mon0 = int(mon(1))
  mon1 = int(mon(2))
  mon2 = int(mon(3))
  mon3 = int(mon(4))
...
!  VernEC(tim4:tim5)=VernEC_fut
 ...
 !! begin change - SMSCG update for 7 day op, 7 day open for contineously for 2 or more months with 0.5 output from CS3 Kevin Kao & NJ
