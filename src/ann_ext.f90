...
function getSFtideArrayEndIndex(daysIncurrMonth,currMonth,currYear) result(outval)
...
!
  use ann
  implicit none
  real,dimension(148),intent(in) :: Qsac, Qexp, Qsjr,currSFtide,DXC, DICU, VERNEC
