...
!
!  FUNCTIONS:
!  May36ANNECTest - Entry point of console application.
!

!****************************************************************************
!
!  PROGRAM: May36ANNECTest
!
...
program May36ANNECTest
    ...
    INTEGER :: loca, vari, ave_t, currM, currY, indx, ind1
    REAL :: actual_val !,AnnLineGen
    ...
    open(UNIT = 100, file = 'input_May36ANNEC.txt', status = 'old')
