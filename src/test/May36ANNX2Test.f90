...
!
!  FUNCTIONS:
!  May36ANNX2Test - Entry point of console application.
!

!****************************************************************************
!
!  PROGRAM: May36ANNX2Test
!
...
program May36ANNX2Test
    ...
    INTERFACE
        FUNCTION Ann_X2(Qsac_prv0, Qsac_prv1, Qsac_prv2, Qsac_prv3, Qsac_prv4, &
            ...
            IMPLICIT NONE
            REAL, INTENT(IN) :: Qsac_prv0, Qsac_prv1, Qsac_prv2, Qsac_prv3, Qsac_prv4, &
                    Qexp_prv0, Qexp_prv1, Qexp_prv2, Qexp_prv3, Qexp_prv4
    ...
    open(UNIT = 100, file = 'input_May36ANNX2.txt', status = 'old')
