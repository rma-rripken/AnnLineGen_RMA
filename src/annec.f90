...
!   4 = Antiock
!   5 = Collins
!   6 = Mallard - Chipps Island - Beldan NJ 09/08/2020
!   7 = LosVaqueros
...
FUNCTION ANNEC( &
  ...
  !DEC$ ATTRIBUTES DLLEXPORT :: annec
  !use ann_ext
  ...
  interface 
      ...
      function ANN_Month(Qsac,Qexp,Qsjr,currSFtide,DICU,DXC,VERNEC,location,days,ave_type,BeginDay, EndDay) result(outval)
          implicit none
          real, dimension(148), intent(in) :: Qsac, Qexp, Qsjr, DXC,currSFtide, DICU, VERNEC   !9/2008
          integer,intent(in) :: location,days,ave_type
...
FUNCTION ANNEC_curMonInpSplit( &
  ...
  !DEC$ ATTRIBUTES DLLEXPORT :: ANNEC_curMonInpSplit
  ...
  INTEGER(C_LONG),INTENT(IN) :: location,mon0,mon1,mon2,mon3,mon4,mon4_1,mon4_2,ave_type
  REAL    :: outputEC
  integer :: tim0,tim1,tim2,tim3,tim4,tim5
  REAL,DIMENSION(148) :: Qsac,Qexp,Qsjr,DXC,Qsac_oth,Qexp_oth,currSFtide,DICU, VernEC !2/14/2005 and 2/24/2005 and 9/2008
  INTEGER             :: i,SFtideStartIndex,SFtideEndIndex !2/14/2005  
...
FUNCTION AnnEC_matchDSM2(Qsac_prv0,Qsac_prv1,Qsac_prv2,Qsac_prv3,Qsac_prv4,Qsac_prv5,Qsac_prv6,&
  ...
  !DEC$ ATTRIBUTES DLLEXPORT :: AnnEC_matchDSM2
  !use ann
  ...
  INTEGER(C_LONG) :: location,mon0,mon1,mon2,mon3,mon4,mon5,mon6,ave_type
  REAL    :: outputEC
  integer :: tim0,tim1,tim2,tim3,tim4,tim5
  REAL,DIMENSION(148) :: Qsac,Qexp,Qsjr,DXC,Qsac_oth,Qexp_oth,currSFtide,DICU, VernEC !2/14/2005 and 2/24/2005 and 9/2008 
  INTEGER             :: i,SFtideStartIndex,SFtideEndIndex !2/14/2005  
...
function DailyEC(sac,sjr,export,currSFtide,DICU,dxc,VernEC,location) result (outputVal)
    ...
    !DEC$ ATTRIBUTES DLLEXPORT :: dailyec
