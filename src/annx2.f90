...
FUNCTION AnnX2( &
  ...
  IMPLICIT NONE
  !DEC$ ATTRIBUTES DLLEXPORT :: annx2
...
FUNCTION ANNX2_curMonInpSplit( &
  ...
  IMPLICIT NONE
  !DEC$ ATTRIBUTES DLLEXPORT :: ANNX2_curMonInpSplit
  ...
  integer, INTENT(IN) :: mon4,location,currMonth, currYear,ave_type ! 2/14/2005
  integer, optional, intent(in) :: BeginDay, EndDay !only used in ave_type ==10
  INTEGER,INTENT(IN) :: mon0,mon1,mon2,mon3,mon4_1,mon4_2
  REAL    :: outputX2
  integer :: tim0,tim1,tim2,tim3,tim4,tim5,det_day !Jan 2009
  REAL,DIMENSION(148) :: Qsac,Qexp,currSFtide !Nov 2008
  INTEGER             :: i,SFtideStartIndex,SFtideEndIndex !2/14/2005  
...
FUNCTION AnnX2_matchDSM2(&
  ...
  IMPLICIT NONE
  !DEC$ ATTRIBUTES DLLEXPORT :: AnnX2_matchDSM2
  !use ann
  interface 
...
function DailyX2(sac,export,currSFtide,location) result (outputVal)
    ...
    !DEC$ ATTRIBUTES DLLEXPORT :: dailyX2
