...
module ann
  ...
  real :: scalingLow=0.1, scalingHigh=0.9 !3/23/2006
    ...
    real ::     EXP_SCALE = 0.00006077,   EXP_OFFSET = 0.04339446
    real ::     SAC_SCALE = 0.00000321,   SAC_OFFSET = 0.08445220
    real ::     SJR_SCALE = 0.00001522,   SJR_OFFSET = 0.09179344
    real ::     SFtide_SCALE = 0.13357822, SFtide_OFFSET = -0.32266818
    real ::     DICU_SCALE = 0.00010116, DICU_OFFSET = 0.60242361
    real ::     VernEC_SCALE = 0.80000000, VernEC_OFFSET = 0.10000000 
    

    !Output scaling factors
    real ::        jpt_scale = 0.00016741,      jpt_OFFSET = 0.25083741  ! 
    real ::      orrsl_scale = 0.00030801,    orrsl_OFFSET = 0.37752022 ! 
    real ::        emm_scale = 0.00011288,      emm_OFFSET = 0.20170613 ! 
    real ::    antioch_scale = 0.00007156, antioch_OFFSET = 0.16447661 ! 
    real ::    collins_scale = 0.00005021, collins_OFFSET = 0.14523970 ! 
    real ::    mallard_scale = 0.00004063, mallard_OFFSET = 0.13660528  !
    real :: losvaqueros_scale = 0.00034725, losvaqueros_OFFSET = 0.41286864 ! 
    ! start of add 7/1/07 swu
    real :: ccfb_scale = 0.00088789, ccfb_OFFSET = 0.053594 !  real :: ccfb_scale = 0.00029679, ccfb_OFFSET = 0.367411 !
    real :: CCFBintake_scale = 0.00039682, CCFBintake_OFFSET = 0.45753856 
    real :: middleriver_scale = 0.00043839, middleriver_OFFSET = 0.49499325 ! 
    real :: VICTintake_scale  = 0.00043157, VICTintake_OFFSET = 0.48884414 ! 
    real :: CVPintake_scale  = 0.00039170, CVPintake_OFFSET =0.45292528 ! 
    real :: x2_scale = 0.01527644, X2_OFFSET = -0.57708485 
    real :: beldan_scale = 0.00004013, beldan_offset = 0.13615934
    real :: MTZ_scale = 0.00002790, MTZ_offset = 0.12513961    	
    !end of add         
...
!       if(inarray(i+inarray_offset+ndays)< (scalingLow-0.01) .or. inarray(i+inarray_offset+ndays) > (scalingHigh+0.01)) then !3/23/2006
 !        scaleAndCopyDaily = .TRUE.
  ...
  function calcdaily(sac,sjr,export,currSFtide,DICU,dxc,VernEC,location)!shengjun 12/16/2004 and 2/25/2005
    ...
    !else        
        EXP_SCALE = 0.00006077;   EXP_OFFSET = 0.04339446;
        SAC_SCALE = 0.00000321;   SAC_OFFSET = 0.08445220;
  ...
  function calcX2daily(sac,export,currSFtide,location)!Hao Mar 2009
    ...
    if (location == 13) then !use the same 6 input names but different meaning, make sure the order is the same of ANN input
       ...
       ! SF tide a: 0.13652
        ...
        EXP_SCALE = 0.00000288; EXP_OFFSET = 0.09135930;     ! Delta_outflow
